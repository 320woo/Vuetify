        ...
        <v-navigation-drawer
          ...
          <v-container fluid px-3>
            <v-layout column wrap>
              ...
              <v-divider class="ma-1"></v-divider>
              <v-layout column>
                <SprayMapAnnotationTools :readonly="isUser()"
                                            class="mapAnnotationTools"></SprayMapAnnotationTools>
                <SprayAreaContents :readonly="isUser()" v-if="getContent"
                                      :spray-plan-id="sprayPlanId"></SprayAreaContents>
              </v-layout>
            </v-layout>
          </v-container>
        </v-navigation-drawer>
...
<script>
  ...
  import SprayMapAnnotationTools from '@/components/map/SprayPlanMapAnnotationTools'
  import MapViewTools from '@/components/map/MapViewTools'
  import DetailImageView from '@/components/common/DetailImageView'
  import { sprayPlanMapMixin } from '@/components/map/sprayPlanMapMixin'
  import SprayAreaContents from '@/components/map/SprayPlanAreaContents'
